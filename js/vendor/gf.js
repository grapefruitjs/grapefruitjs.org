// Combined file generated by uRequire v0.6.1, with help from r.js & almond
(function (global){
...
define(
  'physics/Body',['require','exports','module','../math/Rectangle','../math/Vector','../math/math','../utils/inherit','../constants'],function (require, exports, module) {
...
define(
  'display/Sprite',['require','exports','module','../utils/EventEmitter','../math/Rectangle','../physics/Body','../utils/inherit','./Texture','../math/math','../utils/utils','../vendor/pixi'],function (require, exports, module) {
  
// uRequire v0.6.1: START body of original nodejs module
  var EventEmitter = require("../utils/EventEmitter"), Rectangle = require("../math/Rectangle"), Body = require("../physics/Body"), inherit = require("../utils/inherit"), Texture = require("./Texture"), math = require("../math/math"), utils = require("../utils/utils"), PIXI = require("../vendor/pixi");
...
define(
  'math/Ellipse',['require','exports','module','../vendor/pixi'],function (require, exports, module) {
...
define(
  'tilemap/ObjectGroup',['require','exports','module','../display/Container','../math/Vector','../math/Polygon','../math/Ellipse','../math/Rectangle','../utils/utils','../utils/inherit','../math/math'],function (require, exports, module) {
...
define(
  'tilemap/Tilelayer',['require','exports','module','../display/Container','../math/Rectangle','../math/Vector','../display/Texture','./Tile','../math/math','../utils/utils','../utils/inherit','../utils/support','../constants'],function (require, exports, module) {
...
define(
  'text/BitmapText',['require','exports','module','../display/Container','../utils/ObjectPool','../display/Texture','../display/Sprite','../math/Vector','../math/Rectangle','../utils/utils','../utils/inherit','../vendor/pixi'],function (require, exports, module) {
...
define(
  'utils/ObjectFactory',['require','exports','module','./inherit','../gui/GuiItem','../display/Sprite','../tilemap/Tilemap','../math/Rectangle','../text/BitmapText','../constants'],function (require, exports, module) {
...
define(
  'camera/Camera',['require','exports','module','../display/Container','../display/Sprite','../math/Rectangle','../math/Vector','../utils/ObjectFactory','../utils/inherit','../math/math','../constants'],function (require, exports, module) {
...
define(
  'game/World',['require','exports','module','../utils/inherit','../display/Container','../math/Rectangle','../utils/ObjectFactory','../particles/ParticleSystem'],function (require, exports, module) {
  
// uRequire v0.6.1: START body of original nodejs module
  var inherit = require("../utils/inherit"), Container = require("../display/Container"), Rectangle = require("../math/Rectangle"), ObjectFactory = require("../utils/ObjectFactory"), ParticleSystem = require("../particles/ParticleSystem");
...
define(
  'math/QuadTree',['require','exports','module','./Rectangle','./math','../utils/inherit'],function (require, exports, module) {
...
define('core.js',['require', 'exports', 'module', './constants', './audio/AudioManager', './audio/AudioPlayer', './camera/Camera', './display/BaseTexture', './display/Texture', './display/Container', './display/Sprite', './text/BitmapText', './fx/camera/Effect', './fx/camera/Close', './fx/camera/Fade', './fx/camera/Flash', './fx/camera/Scanlines', './fx/camera/Shake', './game/Game', './game/State', './game/StateManager', './gui/GuiItem', './input/Input', './input/InputManager', './input/Keyboard', './input/Gamepad', './input/gamepad/GamepadButtons', './input/gamepad/GamepadSticks', './input/Pointers', './input/pointer/Pointer', './loader/Loader', './tilemap/Tile', './tilemap/Tilelayer', './tilemap/Tilemap', './tilemap/Tileset', './tilemap/ObjectGroup', './math/math', './math/Circle', './math/Ellipse', './math/Polygon', './math/Rectangle', './math/Vector', './particles/ParticleEmitter', './particles/ParticleSystem', './physics/Physics', './physics/Body', './utils/utils', './utils/support', './utils/inherit', './utils/Cache', './utils/Clock', './utils/EventEmitter', './utils/ObjectPool', './utils/SpritePool', './utils/ObjectFactory', './plugin', './vendor/pixi'], 
